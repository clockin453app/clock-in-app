...
_auth_runtime = build_auth_runtime({
    ...
    "_fernet": _fernet,
    "BASE_DIR": BASE_DIR,
    "get_client_ip_func": lambda: _client_ip(),
    "get_session_workplace_id_func": lambda: _session_workplace_id(),
})

GLOBAL_MASTER_ADMIN_STORE_PATH = _auth_runtime["GLOBAL_MASTER_ADMIN_STORE_PATH"]
GLOBAL_MASTER_ADMIN_SEED_JSON = _auth_runtime["GLOBAL_MASTER_ADMIN_SEED_JSON"]
LIVE_SESSION_STORE_PATH = _auth_runtime["LIVE_SESSION_STORE_PATH"]
LIVE_SESSION_TTL_SECONDS = _auth_runtime["LIVE_SESSION_TTL_SECONDS"]
LIVE_SESSION_RETENTION_SECONDS = _auth_runtime["LIVE_SESSION_RETENTION_SECONDS"]

_find_global_master_admin_record = _auth_runtime["_find_global_master_admin_record"]
_issue_global_master_admin_session_token = _auth_runtime["_issue_global_master_admin_session_token"]
_clear_global_master_admin_session_token = _auth_runtime["_clear_global_master_admin_session_token"]
_validate_global_master_admin_session = _auth_runtime["_validate_global_master_admin_session"]
_touch_live_session_presence = _auth_runtime["_touch_live_session_presence"]
_remove_live_session_presence = _auth_runtime["_remove_live_session_presence"]
_list_current_live_sessions = _auth_runtime["_list_current_live_sessions"]
...
@routes.route("/onboarding-file/<path:relpath>")
def view_onboarding_file(relpath):
    gate = require_login()
    if gate:
        return gate

    relpath = (relpath or "").replace("\\", "/").strip("/")
    full_path = _safe_onboarding_path(relpath)
...
_work_progress_runtime = build_work_progress_storage_runtime({
    "os": os,
    "json": json,
    "io": io,
    "time": time,
    ...
    "get_user_drive_service": get_user_drive_service,
    "get_service_account_drive_service": get_service_account_drive_service,
    "UPLOAD_FOLDER_ID": UPLOAD_FOLDER_ID,
    "MediaIoBaseUpload": MediaIoBaseUpload,
    "Image": Image,
    "ImageOps": ImageOps,
    "_session_workplace_id": _session_workplace_id,
    "_get_active_locations": _get_active_locations,
    "_workplace_ids_for_read": _workplace_ids_for_read,
})

WORK_PROGRESS_BASE_DIR = _work_progress_runtime["WORK_PROGRESS_BASE_DIR"]
WORK_PROGRESS_INDEX_PATH = _work_progress_runtime["WORK_PROGRESS_INDEX_PATH"]
WORK_PROGRESS_MAX_BYTES = _work_progress_runtime["WORK_PROGRESS_MAX_BYTES"]
_ALLOWED_WORK_PROGRESS_EXTS = _work_progress_runtime["_ALLOWED_WORK_PROGRESS_EXTS"]
_ALLOWED_WORK_PROGRESS_MIMES = _work_progress_runtime["_ALLOWED_WORK_PROGRESS_MIMES"]
WORK_PROGRESS_IMAGE_MAX_DIM = _work_progress_runtime["WORK_PROGRESS_IMAGE_MAX_DIM"]
WORK_PROGRESS_IMAGE_QUALITY = _work_progress_runtime["WORK_PROGRESS_IMAGE_QUALITY"]
WORK_PROGRESS_AUTO_ARCHIVE_ENABLED = _work_progress_runtime["WORK_PROGRESS_AUTO_ARCHIVE_ENABLED"]
WORK_PROGRESS_ARCHIVE_DAYS = _work_progress_runtime["WORK_PROGRESS_ARCHIVE_DAYS"]
WORK_PROGRESS_AUTO_ARCHIVE_INTERVAL_S = _work_progress_runtime["WORK_PROGRESS_AUTO_ARCHIVE_INTERVAL_S"]

_ensure_work_progress_storage = _work_progress_runtime["_ensure_work_progress_storage"]
_work_progress_folder_name = _work_progress_runtime["_work_progress_folder_name"]
_work_progress_safe_text = _work_progress_runtime["_work_progress_safe_text"]
_normalize_work_progress_date = _work_progress_runtime["_normalize_work_progress_date"]
_progress_sites_for_current_workplace = _work_progress_runtime["_progress_sites_for_current_workplace"]
_load_work_progress_index = _work_progress_runtime["_load_work_progress_index"]
_save_work_progress_index = _work_progress_runtime["_save_work_progress_index"]
_resolve_work_progress_file_path = _work_progress_runtime["_resolve_work_progress_file_path"]
_optimize_work_progress_image = _work_progress_runtime["_optimize_work_progress_image"]
_store_work_progress_upload = _work_progress_runtime["_store_work_progress_upload"]
_list_work_progress_items_for_session = _work_progress_runtime["_list_work_progress_items_for_session"]
_get_work_progress_archive_drive_service = _work_progress_runtime["_get_work_progress_archive_drive_service"]
_drive_find_or_create_folder = _work_progress_runtime["_drive_find_or_create_folder"]
_upload_local_work_progress_to_archive = _work_progress_runtime["_upload_local_work_progress_to_archive"]
_work_progress_archive_settings = _work_progress_runtime["_work_progress_archive_settings"]
_archive_old_work_progress_files = _work_progress_runtime["_archive_old_work_progress_files"]
_maybe_run_auto_work_progress_archive = _work_progress_runtime["_maybe_run_auto_work_progress_archive"]
